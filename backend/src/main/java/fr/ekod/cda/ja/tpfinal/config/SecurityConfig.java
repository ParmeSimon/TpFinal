...
public class SecurityConfig {
    ...
    // Origines autorisées, externalisées : valeur par défaut en dev, surchargée en prod
    // via la variable d'environnement CORS_ALLOWED_ORIGINS (liste séparée par des virgules).
